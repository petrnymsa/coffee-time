 ...
 * @param radius [optional] Circular radius in meters
...
export async function findPlaces(
  ...
  const params: any = {
    ...
    language: language,
    fields:
      'name,icon,formatted_address,place_id,types,photos,opening_hours,price_level,rating,geometry',
    key: process.env.API_KEY
  };
...
export async function getPlaceDetail(
  ...
  const params = {
    ...
    language: language,
    fields:
      'url,photos,utc_offset,international_phone_number,formatted_phone_number,opening_hours,website,review',
    key: process.env.API_KEY
  };
